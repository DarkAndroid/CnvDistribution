...
PCA = read.table("D:\\THE GREAT_SE_A_GRE_GATOR\\_SCIENCE\\1 Наука КП\\CNV\\CnvDistribution\\Head\\2Scripts\\europeanID_pca.txt", header = FALSE)
...
### 
Related = read.table("D:\\THE GREAT_SE_A_GRE_GATOR\\_SCIENCE\\1 Наука КП\\CNV\\CnvDistribution\\Head\\2Scripts\\id.related", header = FALSE)
nrow(Related) # 39305
...
pdf("D:\\THE GREAT_SE_A_GRE_GATOR\\_SCIENCE\\1 Наука КП\\CNV\\CnvDistribution\\Head\\2Scripts\\TouchingOfPCA.01.R.pdf")
